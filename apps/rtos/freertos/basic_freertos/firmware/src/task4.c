...
/******************************************************************************
  ...
  Remarks:
    Task4 blocks on a switch press semaphore. The semaphore is released from the switch
	press event handler which is called when the user switch is pressed. Once unblocked,
	the task performs work for 10 ticks and then again blocks on the switch press semaphore.
 */
